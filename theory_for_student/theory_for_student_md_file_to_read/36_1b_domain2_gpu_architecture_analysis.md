...
### 📊 Visual Representation: GPU Architecture selection options
This diagram contrasts performance targets across modern GPU architectures like Hopper (H100), Ampere (A100), and Ada Lovelace (L40S).

```mermaid
flowchart LR
    Target["Workload Type"] --> H100["H100 (Max LLM training / FP8 Transformer Engine)"]
    Target --> A100["A100 (Traditional HPC / FP32-FP64 compute)"]
    Target --> L40S["L40S (Mid-size fine-tuning & image gen)"]
