...
### 📊 Visual Representation: Pearson VUE registration pipeline
This flowchart maps out exam booking: registering credentials, scheduling times, and starting proctored exam sessions.

```mermaid
flowchart LR
    Register["1. Create Pearson VUE / NVIDIA account"] --> Schedule["2. Select NCA/AIIO exam & booking time"]
    Schedule --> Test["3. Complete proctored exam session"]
