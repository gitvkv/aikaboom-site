...
```mermaid
flowchart LR
    Host1["Host Server 1"] -->|SCSI / iSCSI blocks| SANSwitch["Fibre Channel Switch"]
    Host2["Host Server 2"] -->|SCSI / iSCSI blocks| SANSwitch
    SANSwitch --> AFA["All-Flash Array Storage Controller"]
