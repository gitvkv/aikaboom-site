...
```mermaid
flowchart LR
    subgraph HGX_B200["HGX B200 Platform"]
        x86["x86 Host CPU"] -->|PCIe Bus| GPUs["8 x B200 GPUs (NVLink Mesh)"]
    end
    subgraph GB200["GB200 Superchip Platform"]
        Grace["Grace ARM CPU"] -->|"NVLink-C2C (900 GB/s)"| B200s["2 x Blackwell GPUs"]
    end
    ...
    class GPUs,B200s cpu;
    class x86,Grace memory;
```
