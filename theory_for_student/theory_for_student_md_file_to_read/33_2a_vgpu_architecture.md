...
```mermaid
flowchart LR
    PhysicalGPU["Physical GPU (A100/H100)"] --> vGPUManager["NVIDIA vGPU Manager (Hypervisor level)"]
    vGPUManager -->|Virtual Device Instance| VM1["VM 1 (NVIDIA vGPU Driver)"]
    vGPUManager -->|Virtual Device Instance| VM2["VM 2 (NVIDIA vGPU Driver)"]

    classDef cpu fill:#eafaf1,stroke:#76b900,stroke-width:2px,rx:6px,ry:6px;
    classDef memory fill:#f0f7ff,stroke:#3498db,stroke-width:1.5px,rx:4px,ry:4px;
    classDef system fill:#f1f5f9,stroke:#64748b,stroke-width:1.5px;

    class vGPUManager cpu;
    class VM1,VM2 memory;
    class PhysicalGPU system;
```
