...
```mermaid
flowchart LR
    App1["CUDA Client App 1"] -->|Submit instructions| MPSControl["MPS Control Daemon Server"]
    App2["CUDA Client App 2"] -->|Submit instructions| MPSControl
    MPSControl -->|Single Unified Context| GPUHardware["GPU Compute Engine"]

    classDef cpu fill:#eafaf1,stroke:#76b900,stroke-width:2px,rx:6px,ry:6px;
    classDef memory fill:#f0f7ff,stroke:#3498db,stroke-width:1.5px,rx:4px,ry:4px;
    classDef system fill:#f1f5f9,stroke:#64748b,stroke-width:1.5px;

    class MPSControl cpu;
    class GPUHardware memory;
    class App1,App2 system;
```
