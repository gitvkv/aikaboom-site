...
```mermaid
flowchart LR
    Epoch["Epoch Start Request"] --> Threads["Thousands of GPU Threads"]
    Threads -->|Query dataset files| NFS["Shared NFS Metadata Cache"]
    NFS -->|Saturate / Lock timeout| Crash["NFS IO Freeze / OOM"]
