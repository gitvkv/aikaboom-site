...
```mermaid
flowchart LR
    Upper["Upper Layer (Read-Write / Container modifications)"] --> Unified["Unified View (Active Container mount)"]
    Lower["Lower Layer (Read-Only Image layers)"] --> Unified
