...
### 📊 Visual Representation: Lustre File Striping Process
This diagram shows how a large dataset file is striped across multiple Object Storage Targets to enable high-throughput parallel reads.

```mermaid
flowchart LR
    File["Large Dataset File (e.g. 100GB)"] -->|Split into chunks| Striping{"Striping Engine"}
    Striping -->|Chunk 1| OST1["OST 1"]
    Striping -->|Chunk 2| OST2["OST 2"]
    Striping -->|Chunk 3| OST3["OST 3"]
    ...
    class Striping cpu;
    class File,OST1,OST2,OST3 memory;
```
