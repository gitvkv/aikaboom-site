...
### 📊 Visual Representation: CUDA Semantic Versioning Scopes
This diagram details Major, Minor, and Patch release compatibility rules for the CUDA Toolkit.

```mermaid
flowchart LR
    Version["CUDA Version: 12.1.3"] --> Major["Major (12): Breaking API Changes / Driver Limits"]
    Version --> Minor["Minor (1): Backwards compatible updates"]
    Version --> Patch["Patch (3): Critical bug fixes"]
