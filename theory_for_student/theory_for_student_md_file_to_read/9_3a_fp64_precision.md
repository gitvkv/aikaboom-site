...
### 📊 Visual Representation: Double Precision (FP64) Bit Breakdown
This diagram details the bit allocations (1 sign bit, 11 exponent bits, 52 mantissa bits) of standard IEEE 754 Double Precision float formats.

```mermaid
flowchart LR
    Bit64["FP64 Word (64 Bits)"] --> Sign["Sign (1 Bit)"]
    Bit64 --> Exp["Exponent (11 Bits)"]
    Bit64 --> Mantissa["Mantissa / Fraction (52 Bits)"]
