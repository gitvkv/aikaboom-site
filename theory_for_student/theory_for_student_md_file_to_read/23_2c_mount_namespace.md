...
### 📊 Visual Representation: Linux Mount Namespace chroot Isolation
This diagram displays how mount namespaces isolate filesystems, giving each container a unique, private view of the directory structure.

```mermaid
flowchart LR
    HostRoot["Host Root File System (/)"] --> Namespace1["Container 1 Mount Namespace (/var/lib/docker/overlay2/root1)"]
    HostRoot --> Namespace2["Container 2 Mount Namespace (/var/lib/docker/overlay2/root2)"]
    ...
    class HostRoot cpu;
    class Namespace1,Namespace2 memory;
```
