...
### 📊 Visual Representation: Grafana Prometheus Datasource querying
This diagram displays how Grafana dashboards query Prometheus data sources to render visual telemetry charts.

```mermaid
flowchart LR
    User["Grafana UI Dashboard"] -->|1. PromQL Query| Grafana["Grafana Server"]
    Grafana -->|2. HTTP Request| Prometheus["Prometheus Datasource"]
    Prometheus -->|3. JSON Metrics| Grafana
