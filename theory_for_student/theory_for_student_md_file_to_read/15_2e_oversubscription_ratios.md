...
```mermaid
flowchart LR
    subgraph NonBlocking["1:1 Non-Blocking"]
        In1["3.2 Tbps Input"] --> Out1["3.2 Tbps Output"]
    end
    subgraph Oversubscribed["3:1 Oversubscribed"]
        In2["9.6 Tbps Input"] --> Out2["3.2 Tbps Output (Bottleneck)"]
    end
