...
```mermaid
flowchart LR
    Image["NGC PyTorch Image Stack"] --> Framework["PyTorch / torchvision"]
    Image --> Toolkit["CUDA Toolkit / NCCL / cuDNN"]
    Image --> DriverLibs["User-space Driver Interfaces"]
