...
```mermaid
flowchart LR
    Cleaned["Cleaned Text/Data"] --> Tokenize["Tokenization & Normalization"]
    Tokenize --> Tensor["Tensor Conversion (Padding/Masking)"]
    Tensor --> DataLoader["PyTorch DataLoader (Batching)"]
    ...
    class Tokenize cpu;
    class Cleaned,Tensor memory;
    class DataLoader system;
```
