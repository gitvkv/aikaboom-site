...
### 📊 Visual Representation: Deployment, ReplicaSet, and Pod Hierarchy
This diagram displays the Deployment structure, showing how the Deployment manages a ReplicaSet to scale target Pod replicas.

```mermaid
flowchart LR
    Deploy["Deployment object"] --> ReplicaSet["ReplicaSet (Scale control: 3)"]
    ReplicaSet --> Pod1["Pod Replica 1"]
    ReplicaSet --> Pod2["Pod Replica 2"]
    ReplicaSet --> Pod3["Pod Replica 3"]

    classDef cpu fill:#eafaf1,stroke:#76b900,stroke-width:2px,rx:6px,ry:6px;
    classDef memory fill:#f0f7ff,stroke:#3498db,stroke-width:1.5px,rx:4px,ry:4px;
    classDef system fill:#f1f5f9,stroke:#64748b,stroke-width:1.5px;

    class ReplicaSet cpu;
    class Pod1,Pod2,Pod3 memory;
    class Deploy system;
```
