...
### 📊 Visual Representation: Rail-Optimized Inter-Switch Connectivity
This diagram details the rail-optimized network layout: GPUs at matching indexes across servers share dedicated switches to avoid inter-switch transit latency.

```mermaid
flowchart LR
    subgraph Servers["Symmetric Servers"]
        S1_G1["Server 1: GPU 1"]
        S2_G1["Server 2: GPU 1"]
    end
    S1_G1 -->|Dedicated Rail 1| Switch1["Rail 1 Switch"]
    S2_G1 -->|Dedicated Rail 1| Switch1

    classDef cpu fill:#eafaf1,stroke:#76b900,stroke-width:2px,rx:6px,ry:6px;
    classDef memory fill:#f0f7ff,stroke:#3498db,stroke-width:1.5px,rx:4px,ry:4px;
    classDef system fill:#f1f5f9,stroke:#64748b,stroke-width:1.5px;

    class S1_G1,S2_G1 cpu;
    class Switch1 system;
```
