...
```mermaid
flowchart LR
    Nodes["16 x GPU Nodes (8 x H100 each)"] --- LeafSwitch["Leaf Switch layer (8 x NDR 400G Switches)"]
    LeafSwitch --- SpineSwitch["Spine Switch layer (Non-blocking network backplane)"]
    ...
    class Nodes cpu;
    class LeafSwitch,SpineSwitch memory;
```
