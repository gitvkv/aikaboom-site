...
```mermaid
flowchart LR
    Created["Created State"] -->|docker start| Running["Running State"]
    Running -->|Application exit / stop| Stopped["Stopped / Exited State"]
    Stopped -->|docker rm| Deleted["Deleted from Disk"]
    ...
    class Running cpu;
    class Created,Stopped memory;
    class Deleted system;
```
