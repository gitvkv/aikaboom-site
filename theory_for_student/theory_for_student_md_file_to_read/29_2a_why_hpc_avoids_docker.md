...
```mermaid
flowchart LR
    DockerApp["Container root user"] -->|Volume bind| HostRoot["Host filesystem (/etc/passwd)"]
    HostRoot -->|Exploit privilege| Takeover["Unauthorized host root access"]
    ...
    class Takeover cpu;
    class HostRoot memory;
    class DockerApp system;
```
