...
```mermaid
flowchart LR
    Templates["Chart Template files"] --> Engine["Helm Render Engine"]
    Values["values.yaml (Custom values)"] --> Engine
    Engine --> Manifests["Final Kubernetes YAML Manifests"]
    ...
    class Engine cpu;
    class Templates,Values memory;
    class Manifests system;
```
