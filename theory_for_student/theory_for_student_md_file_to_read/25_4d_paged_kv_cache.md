...
```mermaid
flowchart LR
    Tokens["Logical KV Cache Tokens"] --> PageTable["PagedAttention Block Table"]
    PageTable --> PhysicalPage1["Physical Block 0 (Host DRAM Page 15)"]
    PageTable --> PhysicalPage2["Physical Block 1 (Host DRAM Page 88)"]
    ...
    class PageTable cpu;
    class PhysicalPage1,PhysicalPage2 memory;
    class Tokens system;
```
