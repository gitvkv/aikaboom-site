...
### 📊 Visual Representation: Dual-Issue Warp Scheduler Pipeline
This flowchart outlines how the warp scheduler selects active warps and issues instructions to execution units (ALUs) every clock cycle.

```mermaid
flowchart LR
    Queue["Active Warp Queue"] --> Sched["Warp Scheduler (checks readiness)"]
    Sched --> Dispatch1["Instruction Issue 1"] --> Units1["FP32/Tensor Core Units"]
    Sched --> Dispatch2["Instruction Issue 2"] --> Units2["LD/ST Memory Units"]

    classDef cpu fill:#eafaf1,stroke:#76b900,stroke-width:2px,rx:6px,ry:6px;
    classDef memory fill:#f0f7ff,stroke:#3498db,stroke-width:1.5px,rx:4px,ry:4px;
    classDef system fill:#f1f5f9,stroke:#64748b,stroke-width:1.5px;

    class Units1,Units2 cpu;
    class Queue memory;
    class Sched,Dispatch1,Dispatch2 system;
```
