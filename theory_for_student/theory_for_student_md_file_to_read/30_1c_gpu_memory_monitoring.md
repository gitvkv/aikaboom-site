...
```mermaid
flowchart LR
    VRAM["GPU HBM/GDDR VRAM"] --> Framebuffer["Framebuffer Memory (Allocated to model weights)"]
    VRAM --> BAR1["BAR1 Memory (Host-accessible mappings for DMA transfers)"]
