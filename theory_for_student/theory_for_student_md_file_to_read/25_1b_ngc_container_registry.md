...
```mermaid
flowchart LR
    CLI["Docker CLI"] -->|"1. Authenticate ($nvgo)"| NGC["NGC Registry Portal"]
    NGC -->|2. Authorize token| CLI
    CLI -->|3. docker pull nvcr.io/...| Pull["Pull GPU-Optimized Image"]
