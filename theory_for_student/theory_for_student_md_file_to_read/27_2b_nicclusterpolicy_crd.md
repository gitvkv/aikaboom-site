...
### 📊 Visual Representation: NicClusterPolicy Spec fields
This diagram displays the NicClusterPolicy CRD, configuring OFED driver containers and SR-IOV profiles.

```mermaid
flowchart LR
    NicPolicy["NicClusterPolicy CRD"] --> OfedSpec["ofedDriver.enabled / version"]
    NicPolicy --> SriovSpec["sriovDevicePlugin.enabled"]
    NicPolicy --> SecondaryNetwork["secondaryNetwork.multus"]
    ...
    class NicPolicy cpu;
    class OfedSpec,SriovSpec,SecondaryNetwork memory;
```
