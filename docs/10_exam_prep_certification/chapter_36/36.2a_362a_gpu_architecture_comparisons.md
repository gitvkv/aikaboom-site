...
<div class="lesson-completion" data-lesson-id="36_2a_a100_vs_h100_vs_l40s"></div>
...
```mermaid
flowchart LR
    subgraph H100["H100 Hopper"]
        H100Spec["80GB HBM3 / DPX / Transformer Engine / NVLink v4"]
    end
    subgraph A100["A100 Ampere"]
        A100Spec["80GB HBM2 / MIG / TF32 / NVLink v3"]
    end
    subgraph L40S["L40S Ada"]
        L40SSpec["48GB GDDR6 / FP8 Tensor Cores / PCIe Gen4 Only"]
    end
    ...
    class H100Spec,A100Spec,L40SSpec memory;
```
